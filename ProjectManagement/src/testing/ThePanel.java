...
public class ThePanel extends JPanel {
	...
	public ThePanel(JPanel toAdd, Boolean click){
	...
	public ThePanel(String name, String imgPath) {
		...
		Font f = null;
		try {
			f = Font.createFont(Font.TRUETYPE_FONT, new File("./resource/Slabo_27px/Slabo27px-Regular.ttf"));
	...
	public void doAction(){action.run();}
